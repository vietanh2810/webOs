class ClockApp extends HTMLElement {
  ...
  connectedCallback () {
    ...
    document.getElementById('startMinuterie').addEventListener('click', function () {
    ...
    document.getElementById('stopMinuterie').addEventListener('click', function () {
      if (localStorage.getItem('vibrating') === 'true') {
        navigator.vibrate(50)
      }
      clearInterval(timer)
    ...
    document.getElementById('resetMinuterie').addEventListener('click', function () {
      if (localStorage.getItem('vibrating') === 'true') {
        navigator.vibrate(50)
      }
      clearInterval(timer)
    ...
    function getIdCurrTab () {
      if (currTab === 'horloge') {
        return '#clock'
      } else if (currTab === 'chrono') {
        return '#chronoId'
      } else if (currTab === 'minuterie') {
        return '#minuterieId'
      }
    }
